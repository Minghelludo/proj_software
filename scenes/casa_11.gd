...
@onready var prox_casa = get_parent().get_node("casa_12")
@onready var parente = get_parent().get_node("casa_13")
@onready var parente_2 = get_parent().get_node("casa_14")
const pos = Vector2(125,50)
@onready var proprietario = null
const custo_compra = 1000
var custo_aluguel = 200
var quant_casas = 0
@onready var label = $Label_props_c11
@onready var label_dono = $Label_dono_c11
