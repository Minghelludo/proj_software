...
@onready var prox_casa = get_parent().get_node("casa_35")
@onready var parente = get_parent().get_node("casa_31")
@onready var parente_2 = get_parent().get_node("casa_32")
const pos = Vector2(375,600)
@onready var proprietario = null
const custo_compra = 1000
var custo_aluguel = 200
var quant_casas = 0
@onready var label = $Label_props_c34
@onready var label_dono = $Label_dono_c34
