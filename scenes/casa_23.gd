extends Node2D
#casa propriedade
#comentarios pertinentes na casa_1
@onready var prox_casa = get_parent().get_node("casa_24")
@onready var parente = get_parent().get_node("casa_21")
@onready var parente_2 = get_parent().get_node("casa_24")
const pos = Vector2(600,225)
@onready var proprietario = null
const custo_compra = 1000
var custo_aluguel = 200
var quant_casas = 0
@onready var label = $Label_props_c23
@onready var label_dono = $Label_dono_c23
